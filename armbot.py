...
# =================================================================
# [อัปเกรด] ระบบเซฟและโหลดข้อมูลแบบผูกมัดค่าช่องกรอกฝั่งซ้ายทั้งหมด
# =================================================================
...
def save_data_permanently():
    """เซฟข้อมูลทุกอย่างบนหน้าจอลงไฟล์ JSON ถาวร"""
    data = {
...
def load_data_permanently():
    """โหลดข้อมูลแชตและสถานะปุ่มฝั่งซ้ายกลับคืนชีพมาให้ครบเมื่อโดนรีเฟรช"""
...
# 🚨 ทำการโหลดข้อมูลเก่าจากดิสก์ขึ้นมาเตรียมพร้อมไว้ก่อนวาดหน้าจอ (แก้ไขบั๊ก F5 แล้วลืมค่า)
...
# ✨ [ผูกมัดค่าความจำ] ช่องข้อมูลตัวละครจะล็อกค่าเดิมไว้ให้ตลอดผ่าน key และเซฟออโต้เมื่อมีการพิมพ์เปลี่ยนข้อความ
...
# ✨ [ผูกมัดค่าความจำ] ช่องเลือกสไตล์จะจำสไตล์ล่าสุดที่คุณกดเลือกไว้ตลอดชีวิตผ่านระบบเซฟออโต้
